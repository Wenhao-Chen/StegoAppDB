...
public class HuffmanDecode {
    ...
    // Constructor Method
    public HuffmanDecode(final byte[] data) throws Exception{
    ...
    private void Decode_AC_coefficients() throws Exception{
        this.K = 1;
    ...
    private void dqt() throws Exception{
    ...
    private void dri() throws Exception{
        getInt();
        this.RI = getInt();
    }
    ...
    // Return image data
    public void HuffDecode(final int[][][] buffer) throws Exception{
        int x, y, tmp;
    ...
    private int NextBit() throws Exception{
    ...
    public void rawDecode(final int[][][] buffer) throws Exception{
        int x, y, tmp;
        final int[][] Block = new int[8][8];
        int Cs, Ta, Td, blocks;
        final long t;
    ...
    private int RECEIVE(final int SSS) throws Exception{
        int V = 0, I = 0;
    ...
    public void RGBdecode(final int[][][] Lum) throws Exception{
    ...
    private void sof0() throws Exception{
